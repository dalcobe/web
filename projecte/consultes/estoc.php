...
<html lang="ca" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Filtrar Productes (Ordenat per Estoc)</title>
    ...
    <main>
      ...
      <div class="taula_centrada">
        <table>
          ...
          <?php
          $sql="SELECT * from productes,categoria,fet where productes.codi_cat=categoria.codi_cat and productes.codi_prod=fet.codi_prod  order by estoc";
